  ...
  return (
    <div className="relative flex items-center justify-center h-screen w-full bg-gradient-to-r from-black via-slate-800 to-black p-10">
      ...
      <div className="flex items-center flex-col gap-2">
        <p className=" text-align text-center text-5xl">Please Select Your Date & Time</p>
      </div>
      <div className="w-full bg-gradient-to-r from-slate-800 to-blue-900 h-[300px] shadow-xl p-10 pt-15">
       <div className="flex flex-row gap-10 items-center justify-center">
        ...
        className="text-black p-4 rounded-xl w-[300px] bg-white outline-none placeholder-gray-400"
        >
        </input>
       </div>
       <div className="ml-23 mt-10">
        <button onClick={() => router.push("/thanks/done")} className="text-black bg-cyan-400 p-5 w-[250px] rounded-xl hover:duration-300 ease-in cursor-pointer hover:text-white hover:bg-blue-700">Submit</button>
       </div>
      </div>
      </div>
    </div>
