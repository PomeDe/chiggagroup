  ...
  return (
    <div className="relative flex items-center justify-center h-screen w-full bg-gradient-to-r from-black via-[#0F1425] to-black overflow-hidden px-10 py-20">
      ...
      <div className="h-full w-[400px] flex items-center justify-center pb-40">
        <img src="https://img.sm360.ca/ir/w640h390c/images/newcar/ca/2024/mercedes-benz/amg-gt-coupe-4-portes/53-4matic-/coupe/main/2024_Mercedes-Benz_AMG_GT_Coupe_4-Door_1-53-4MATIC_EXT_001_993.png" className="w-[700px]">
        </img>
      </div>
